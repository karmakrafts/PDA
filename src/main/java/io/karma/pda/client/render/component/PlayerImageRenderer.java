 ...
 */
@OnlyIn(Dist.CLIENT)
public final class PlayerImageRenderer implements ComponentRenderer<PlayerImage> {
    @Override
    public void render(final PlayerImage component, final FlexNode flexNode, final GFX graphics) {
