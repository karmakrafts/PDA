 ...
 */
@OnlyIn(Dist.CLIENT)
public final class ImageRenderer implements ComponentRenderer<Image> {
    @Override
    public void render(final Image component, final FlexNode flexNode, final GFX graphics) {
