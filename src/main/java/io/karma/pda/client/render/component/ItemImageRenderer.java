 ...
 */
@OnlyIn(Dist.CLIENT)
public final class ItemImageRenderer implements ComponentRenderer<ItemImage> {
    @Override
    public void render(final ItemImage component, final FlexNode flexNode, final GFX graphics) {
