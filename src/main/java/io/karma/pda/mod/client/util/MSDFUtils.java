...
import io.karma.pda.mod.client.render.graphics.font.MSDFException;
        ...
        if (result != MSDFGen.MSDF_SUCCESS) {
            switch (result) {
                case MSDFGen.MSDF_ERR_FAILED:
                    throw new MSDFException("Operation failed");
                case MSDFGen.MSDF_ERR_INVALID_ARG:
                    throw new MSDFException("Invalid argument");
                case MSDFGen.MSDF_ERR_INVALID_TYPE:
                    throw new MSDFException("Invalid type");
                case MSDFGen.MSDF_ERR_INVALID_SIZE:
                    throw new MSDFException("Invalid size");
                case MSDFGen.MSDF_ERR_INVALID_INDEX:
                    throw new MSDFException("Invalid index");
                default:
                    throw new MSDFException("Unknown error");
            }
        }
    }
