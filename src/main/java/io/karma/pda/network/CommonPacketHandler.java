...
import io.karma.pda.network.cb.CPacketCloseApp;
import io.karma.pda.network.cb.CPacketCreateSession;
import io.karma.pda.network.cb.CPacketOpenApp;
import io.karma.pda.network.cb.CPacketTerminateSession;
import io.karma.pda.network.sb.*;
import io.karma.pda.session.DefaultSessionHandler;
import io.karma.pda.session.DockedSessionContext;
import io.karma.pda.session.HandheldSessionContext;
