...
public final class PacketIDs {
    ...
    public static final int SB_ADD_SYNC_VALUE = getNextId();
    public static final int SB_REMOVE_SYNC_VALUE = getNextId();
    ...
    public static final int CB_ADD_SYNC_VALUE = getNextId();
    public static final int CB_REMOVE_SYNC_VALUE = getNextId();
