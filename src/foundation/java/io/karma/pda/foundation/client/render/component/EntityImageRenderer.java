 ...
 */
@OnlyIn(Dist.CLIENT)
public final class EntityImageRenderer extends AbstractComponentRenderer<EntityImage> {
    @Override
    public void render(final EntityImage component, final FlexNode flexNode, final Graphics graphics) {
